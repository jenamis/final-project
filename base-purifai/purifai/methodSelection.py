...
class model_selection:
    def __init__(self, saved_spe_model , 
                 saved_spe_scaler,
                 saved_lcms_model ,
                 saved_lcms_scaler):
...
if __name__ == '__main__':
    ...
    model_object = model_selection('base-purifai/purifai/spe_brf_model.pkl', 
                 'base-purifai/purifai/spe_scaler.pkl',
                 'base-purifai/purifai/lcms_brf_model.pkl',
                 'base-purifai/purifai/lcms_scaler.pkl')
