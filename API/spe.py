...
class spe:
    ...
    def RawDataToFeatures(self, input):
        print('Your first api!!!')
        features = []
        return features
    def RunPrediction(self, smile):
        y = self.model.predict(smile)
        return y
if __name__ == '__main__':
    model_object = spe('API/model_spe.sav')
    ...
    model_object.RunPrediction(model_object.RawDataToFeatures())
